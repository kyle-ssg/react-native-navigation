...
function startSingleScreenApp (params) {
	...
	navStack.push(screenInstanceID);
...
function navigatorPush (navigator, params) {
	...
	if (!isCurrentScreen(navigator)) {
		console.log('Navigator.push from old screen');
		return;
	}
	const screenInstanceID = _.uniqueId('screenInstanceID');
	const {
...
function isCurrentScreen (navigator) {
	return navigator.screenInstanceID == getCurrentScreen();
}

function navigatorPop (navigator, params) {

	if (!isCurrentScreen(navigator) && !params.force) {
		console.log('Navigator.pop from old screen');
		return;
	}
	navStack.pop();
	console.log(getCurrentScreen());
	var navController = Controllers.NavigationControllerIOS(navigator.navigatorID);
...
function navigatorSetTitle (navigator, params) {
	if (getCurrentScreen() == navigator.screenInstanceID || params.force) {
