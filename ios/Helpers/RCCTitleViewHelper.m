...
-(void)setup:(NSDictionary*)style
{
    ...
    UITapGestureRecognizer *titleTapRecognizer=[[UITapGestureRecognizer alloc]initWithTarget:self.navigationController action:@selector(titleTapped)];
    [titleTapRecognizer setNumberOfTouchesRequired:1];
    
    [self.titleView addGestureRecognizer:titleTapRecognizer];
...
-(void)setupTitleImage
{
    ...
    UIImageView *imageView=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 85, 34)];
