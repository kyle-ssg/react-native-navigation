...
-(void) titleTapped {
  RCTEventDispatcher *dispatcher = [[RCCManager sharedInstance] getBridge].eventDispatcher;
  [dispatcher sendAppEventWithName:@"titlePressed"
                                               body:@{@"title": self.visibleViewController.title}];
}
